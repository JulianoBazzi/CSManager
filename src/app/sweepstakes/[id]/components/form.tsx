...
import { Box, Flex, Icon, IconButton, Separator, Stack, Text, useBreakpointValue } from '@chakra-ui/react';
...
} from '~/app/sweepstakes/[id]/components/new-sweepstake-player-modal';
import {
  SweepstakeMapModal,
  type SweepstakeMapModalHandle,
} from '~/app/sweepstakes/[id]/components/sweepstake-map-modal';
import {
  SweepstakeMapRankingModal,
  type SweepstakeMapRankingModalHandle,
} from '~/app/sweepstakes/[id]/components/sweepstake-map-ranking-modal';
...
export function SweepstakeForm({ user, sweepstake: sweepstakeProp }: ISweepstakesProps) {
          ...
          <CardBody>
            <Box overflowX="auto">
              <Table
                ...
                loading={isLoadingSweepstakeRankings}
                perPage={20}
                orderBy={{
                  id: 'damage',
                  desc: true,

...
import {
  ...
  type PlayerLeaderboardModalHandle,
} from '~/app/sweepstakes/[id]/components/player-leaderboard-modal';
...
import { TABLE_PLAYERS, TABLE_RANKING, VIEW_MAP_RANKING, VIEW_SWEEPSTAKE_RANKING } from '~/config/constants';
